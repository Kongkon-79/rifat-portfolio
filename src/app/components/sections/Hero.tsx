...
import imgRifat2 from '../../../assets/hero_img.png';
...
export function Hero({ heroRef, scrollToSection, contactRef }: HeroProps) {
  ...
  return (
    <div
      ref={heroRef}
      className="relative h-[700px] sm:h-[800px] pt-[120px] md:pt-[150px] px-[20px] md:px-[64px] lg:px-[128px] flex items-center overflow-hidden"
    >
      {/* Animated Circle Background */}
      <motion.div
        className="absolute right-[-150px] sm:right-[-100px] lg:right-[50px] top-[150px] lg:top-[200px] opacity-20 sm:opacity-30 lg:opacity-40 pointer-events-none"
        animate={{
          x: mousePosition.x * 2,
          y: mousePosition.y * 2,
        }}
      ...
      >
        <AnimatedCircle size={500} strokeWidth={3} />
      </motion.div>

      {/* Gradient Background Effect with Parallax */}
      <motion.div
        className="absolute right-[-250px] sm:right-[-200px] lg:right-[22px] size-[350px] sm:size-[400px] lg:size-[540px] top-[180px] sm:top-[200px] lg:top-[343px] opacity-40 sm:opacity-50 lg:opacity-100"
        animate={{
      ...
      >
        <div className="absolute inset-[-92.59%]">
          <svg
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                />
                <feGaussianBlur
                  result="effect1_foregroundBlur_1_606"
                  stdDeviation="250"
                />
              </filter>
              <linearGradient
              ...
              >
                ...
                <stop offset="1" stopColor="#8E5CF0" />
              </linearGradient>
            </defs>
          </svg>
        </div>
      ...
      {[...Array(5)].map((_, i) => (
        <motion.div
          key={i}
          className="absolute size-1.5 sm:size-2 rounded-full bg-gradient-to-br from-[#ff6b35] to-[#8b5cf6] opacity-30 sm:opacity-40"
          style={{
            left: `${20 + i * 15}%`,
            top: `${30 + i * 10}%`,
          }}
      ...
      {/* Hero Content */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-[24px] sm:gap-[32px] lg:gap-[48px] items-center w-full max-w-[1312px] mx-auto">
        <motion.div
          initial={{ opacity: 0, x: -50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8, delay: 0.2 }}
          className="flex flex-col gap-[20px] sm:gap-[24px] lg:gap-[32px] order-2 lg:order-1"
        >
          <div className="flex flex-col gap-[8px] sm:gap-[10px]">
            <p className="font-['Kumbh_Sans:Regular',sans-serif] text-[18px] sm:text-[24px] lg:text-[32px] text-[rgba(196,196,196,0.8)]">
              Hi I am
            </p>
          ...
          {/* Social Icons */}
          <div className="flex gap-[10px] sm:gap-[12px] items-center flex-wrap">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-[12px] sm:gap-[16px] lg:gap-[36px] w-full lg:w-[500px]">
            <motion.button
        ...
        >
          <div className="h-[350px] w-[275px] sm:h-[450px] sm:w-[355px] lg:h-[620px] lg:w-[489px] relative">
            <img
              alt="Rifat Hossain"
              className="absolute h-[118.39%] left-[-0.03%] top-[-5.07%] w-[100.05%] object-cover"
              src={imgRifat2}
            />
          </div>
        </motion.div>
